...
$query = "SELECT * FROM thoughts ORDER BY create_time DESC"; // Adjust this query based on your actual database structure
...
$cars = [];
$query_cars = "SELECT * FROM cars ORDER BY id ASC"; // Modify this query based on your actual car table
